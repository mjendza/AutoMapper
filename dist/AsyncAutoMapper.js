    ...
    AsyncAutoMapper.prototype.processTransformation = function (property, transformation, options, callback) {
        switch (transformation.transformationType) {
            ...
            case AutoMapperEnumerations_1.DestinationTransformationType.MemberOptions: {
                var result = transformation.memberConfigurationOptionsFunc ? transformation.memberConfigurationOptionsFunc(options) : undefined;
            ...
            case AutoMapperEnumerations_1.DestinationTransformationType.SourceMemberOptions: {
                var result = transformation.sourceMemberConfigurationOptionsFunc ? transformation.sourceMemberConfigurationOptionsFunc(options) : undefined;
                if (typeof result !== 'undefined') {
                    options.intermediatePropertyValue = result;
                }
                else if (!options.sourceObject) {
            ...
            case AutoMapperEnumerations_1.DestinationTransformationType.AsyncMemberOptions:
                ...
                return;
            case AutoMapperEnumerations_1.DestinationTransformationType.AsyncSourceMemberOptions:
...
exports.AsyncAutoMapper = AsyncAutoMapper;
