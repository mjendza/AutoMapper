...
var AutoMapperHelper = /** @class */ (function () {
    ...
    AutoMapperHelper.getDestinationTransformation = function (func, isFunction, sourceMapping, async) {
        if (!isFunction) {
            return {
                transformationType: AutoMapperEnumerations_1.DestinationTransformationType.Constant,
                constant: func
            };
        }
        var transformation;
        if (sourceMapping) {
            if (async) {
                transformation = {
                    transformationType: AutoMapperEnumerations_1.DestinationTransformationType.AsyncSourceMemberOptions,
                    asyncSourceMemberConfigurationOptionsFunc: func
                };
            }
            else {
                transformation = {
                    transformationType: AutoMapperEnumerations_1.DestinationTransformationType.SourceMemberOptions,
            ...
            if (async) {
                transformation = {
                    transformationType: AutoMapperEnumerations_1.DestinationTransformationType.AsyncMemberOptions,
                    asyncMemberConfigurationOptionsFunc: func
                };
            }
            else {
                transformation = {
                    transformationType: AutoMapperEnumerations_1.DestinationTransformationType.MemberOptions,
...
exports.AutoMapperHelper = AutoMapperHelper;
