import {IDestinationProperty, IMapping, ISourceProperty} from './contracts';
...
export class AutoMapperValidator {
    ...
    private static assertMappingConfiguration(mapping: IMapping, strictMode: boolean): void {
        ...
        var tryHandle = (errorMessage: string | undefined): void => {
            if (errorMessage) {
    ...
    private static validatePropertyMapping(propertyMapping: ISourceProperty, member: any, srcObj: any, dstObj: any): string | undefined {
    ...
    private static validateProperty(srcMember: any, dstObj: any): string | undefined {
    ...
    private static getDestinationProperty(destinationPropertyName: string, existingSource: ISourceProperty): IDestinationProperty | null {
